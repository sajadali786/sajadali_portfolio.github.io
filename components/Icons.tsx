...
export const GoogleScholarIcon: React.FC = () => (
    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path d="M12 24c5.523 0 10-4.477 10-10S17.523 4 12 4 2 8.477 2 14s4.477 10 10 10zm0-18c4.411 0 8 3.589 8 8s-3.589 8-8 8-8-3.589-8-8 3.589-8 8-8z"/>
        <path d="M12 12.267l-4.5 2.25L12 17.5l4.5-2.983-4.5-2.25zM12 6l-7 3.5L12 13l7-3.5L12 6z"/>
    </svg>
);
